...
public class RangeSquareTest {
	...
	public void testRectanglePositions5() {
		...
		List<IPosition<Integer, Integer>> rangedPositions =  RangeSquare.getPositions(posicion, mapM, 4);
	...
	public void testRectanglePositionsMiddle5() {
		...
		List<IPosition<Integer, Integer>> rangedPositions =  RangeSquare.getPositions(posicion, mapM, 1);
	...
	@Test
	public void testRectanglePositionsMiddle0() {
		
		MapaMatrix mapM = new MapaMatrix(5);
		
		Posicion<Integer, Integer> posicion = new Posicion<Integer, Integer>(2, 2);
		List<IPosition<Integer, Integer>> rangedPositions =  RangeSquare.getPositions(posicion, mapM, 0);
		assertTrue(rangedPositions.size()==1*1,"Has the a good length");
		assertTrue(rangedPositions.contains(new Posicion<Integer, Integer>(2,2)),"Contains the position 2.2 ");	
		assertFalse( rangedPositions.contains(new Posicion<Integer, Integer>(1,1)),"Contains the position 1.1 ");
		assertFalse( rangedPositions.contains(new Posicion<Integer, Integer>(3,1)),"Contains the position 3.1 ");
		assertFalse( rangedPositions.contains(new Posicion<Integer, Integer>(1,3)),"Contains the position 1.3 ");
